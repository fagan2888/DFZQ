...
class UpdateSwapData:
    ...
    def process_data(self, start_input, end_input):
        calendar = self.rdf.get_trading_calendar()
        rdf_query = 'select TRANSFERER_WINDCODE, TARGETCOMP_WINDCODE, CONVERSIONRATIO, ANNCEDATE, ' \
...
if __name__ == '__main__':
    us = UpdateSwapData()
    us.process_data(20190101, 20200201)
