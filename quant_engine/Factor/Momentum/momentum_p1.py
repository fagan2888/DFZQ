        ...
        for code in codes:
            ...
            for idx, row in code_df.iterrows():
                ...
                if period_m1_df.shape[0] < 10:
                    ...
                    if period_m1_df['turnover'].sum() == 0:
                        wgt_rtn_m1 = 0
                        float_wgt_rtn_m1 = 0
                        free_wgt_rtn_m1 = 0
                        exp_wgt_rtn_m1 = 0
                        float_exp_wgt_rtn_m1 = 0
                        free_exp_wgt_rtn_m1 = 0
                    else:
                        period_m1_df['n_days_to_idx'] = range(period_m1_df.shape[0] - 1, -1, -1)
                        period_m1_df['exp_wgt'] = period_m1_df['n_days_to_idx'].apply(
                            lambda x: math.exp(x * -1 / 1 / 4))
                        wgt_rtn_m1 = \
                ...
                if period_m3_df.shape[0] < 30:
                    ...
                    if period_m3_df['turnover'].sum() == 0:
                        wgt_rtn_m3 = 0
                        float_wgt_rtn_m3 = 0
                        free_wgt_rtn_m3 = 0
                        exp_wgt_rtn_m3 = 0
                        float_exp_wgt_rtn_m3 = 0
                        free_exp_wgt_rtn_m3 = 0
                    else:
                        period_m3_df['n_days_to_idx'] = range(period_m3_df.shape[0] - 1, -1, -1)
                        period_m3_df['exp_wgt'] = period_m3_df['n_days_to_idx'].apply(
                            lambda x: math.exp(x * -1 / 3 / 4))
                        wgt_rtn_m3 = \
                ...
                if period_m6_df.shape[0] < 60:
                    ...
                    if period_m6_df['turnover'].sum() == 0:
                        wgt_rtn_m6 = 0
                        float_wgt_rtn_m6 = 0
                        free_wgt_rtn_m6 = 0
                        exp_wgt_rtn_m6 = 0
                        float_exp_wgt_rtn_m6 = 0
                        free_exp_wgt_rtn_m6 = 0
                    else:
                        period_m6_df['n_days_to_idx'] = range(period_m6_df.shape[0] - 1, -1, -1)
                        period_m6_df['exp_wgt'] = period_m6_df['n_days_to_idx'].apply(
                            lambda x: math.exp(x * -1 / 6 / 4))
                        wgt_rtn_m6 = \
                ...
                if period_m12_df.shape[0] < 120:
                    ...
                    if period_m12_df['turnover'].sum() == 0:
                        wgt_rtn_m12 = 0
                        float_wgt_rtn_m12 = 0
                        free_wgt_rtn_m12 = 0
                        exp_wgt_rtn_m12 = 0
                        float_exp_wgt_rtn_m12 = 0
                        free_exp_wgt_rtn_m12 = 0
                    else:
                        period_m12_df['n_days_to_idx'] = range(period_m12_df.shape[0] - 1, -1, -1)
                        period_m12_df['exp_wgt'] = period_m12_df['n_days_to_idx'].apply(
                            lambda x: math.exp(x * -1 / 12 / 4))
                        wgt_rtn_m12 = \
