...
if __name__ == "__main__":
    ...
    a = rdf_data()
    '''
    df = a.get_strange_trade(20150101,20190619)
    bool_type = df['type'].str.contains('02').fillna(False) | df['type'].str.contains('03').fillna(False) |\
    ...
    df = df[bool_type & bool_huatai]
    print(df)
    '''
    b = a.get_index_constituent_df('IC',20190719)
    cd = b['constituent_code'].tolist()
    print(cd)
    fst = a.filter_st(20180101,*cd)
    sts.ewm()